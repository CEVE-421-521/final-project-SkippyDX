...
Verifying that these two additions, scarcity and housing discount rate, were implemented as expected allows the following results to be interpreted as the outcomes of the intended alterations to the model.
